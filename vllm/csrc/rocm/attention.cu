...
// [DCU Optimize] MFMA paged-attn needs mai-insts (MI only).
// gfx936 lacks MFMA → keep DCU out of this gate; decode attn stays on Triton.
// (skinny_gemms.cu separately enables GFX9 for gfx936 with portable DOT2C.)
