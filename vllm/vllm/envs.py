...
if TYPE_CHECKING:
    ...
    # [DCU Optimize] Runtime KV FP8 on gfx936 (in-memory only; no weight dump).
    # Default False for accuracy safety; set 1 after run_accuracy.sh Δ<1%.
    VLLM_ROCM_KV_FP8: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # [DCU Optimize] Optional runtime KV FP8 (fp8_e4m3fnuz) when cache_dtype=auto
    "VLLM_ROCM_KV_FP8": lambda: (
        os.getenv("VLLM_ROCM_KV_FP8", "False").lower() in ("true", "1")
    ),
