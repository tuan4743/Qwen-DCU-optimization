...
def compute_causal_conv1d_metadata(
    ...
    *,
    ...
    # [DCU Optimize] Include 16: gfx936 causal_conv1d uses BLOCK_M=16 on
    # long prefill to cut program count (TTFT). Keep 8 for other platforms.
    for BLOCK_M in [8, 16]:  # cover all BLOCK_M values
