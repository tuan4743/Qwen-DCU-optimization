...
# [DCU Optimize] Narrow FLA chunk_o autotune on ROCm/gfx936 for Qwen3.5 GDN
# (K=V=128). Prefer warps=4 (avoid LDS-heavy warps=8 picks); keep stages∈{2,3}
# — NOT a single-config pin (v8 钉死 = 负优化). Precision: same math.
