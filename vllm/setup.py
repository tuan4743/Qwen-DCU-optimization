...
# [DCU Optimize] Build _rocm_C as optional: eval without HIP toolchain still
# installs; when cmake/hipcc available, skinny GEMV (wvSplitK/LLMM1) ships.
# Runtime gate: on_gfx936() + rocm_skinny_ops_available() → else F.linear.
if _is_hip():
