...
// However, it may be possible to fix these kernels to handle both issues.
  ...
  #define __HIP__GFX9__     /* [终稿 1.1b] 纳入 DCU(gfx936/938), wvSplitK/LLMM1 可编译 */
#endif

/* [终稿 1.1b] 海光 DCU gfx93x 特化:改 shfl 归约、禁用不可靠 mov_dpp
 * 注:重建自说明文档 image 5 截图;实际 kernel 内 shfl/mov_dpp 分支点未在截图给出,
 * 需要按 19 号文档 §1.4/§1.5 的结论人工补全(此处仅定义宏开关)。 */
#if defined(__HIPCC__) && (defined(__gfx936__) || defined(__gfx938__))
  #define __HIP_DCU_GFX93X__ 1
#endif
